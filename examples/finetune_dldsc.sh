...
python dldsc.py mode='Train' \
                ...
                training.epochs=2 \
                finetune.pretrained_model="${out_dir}/ALL_MAF:0.01_X2:80_INFO:0.6_SQ_BASELINE_LR:1e-4_VAL:1-22.best.pth" \
                data.N=$N \
                ...
                output.run_id='ALL_MAF:0.01_Z:80_INFO:0.6_SQ_BASELINE_LR:1e-4_VAL:1-22' \
                output.dir=$out_dir \
